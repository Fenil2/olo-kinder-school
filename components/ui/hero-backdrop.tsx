...
export function HeroBackdrop({ nextBand = 'text-background' }: HeroBackdropProps) {
  return (
    <div aria-hidden="true" className="absolute inset-0 overflow-hidden bg-linear-to-b from-surface-leaf via-surface-blush to-secondary">
      ...
      {/* Clouds */}
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/cloud" alt="" className="absolute top-5 left-[4%] w-24 sm:w-36 opacity-90" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/cloud" alt="" className="absolute top-16 right-[30%] w-20 sm:w-28 opacity-70" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/cloud" alt="" className="absolute top-[34%] left-[26%] w-16 sm:w-24 opacity-55 hidden sm:block" />

      {/* Butterflies drifting near the top corners */}
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/butterfly" alt="" className="absolute top-[26%] right-[6%] w-10 sm:w-14 -rotate-12" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/leaf-1" alt="" className="absolute top-[18%] left-[12%] w-8 sm:w-12 rotate-12 opacity-80 hidden sm:block" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/leaf-2" alt="" className="absolute bottom-[38%] right-[16%] w-8 sm:w-12 -rotate-6 opacity-80 hidden sm:block" />
      ...
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/tree-green" alt="" className="absolute bottom-2 left-[2%] w-20 sm:w-28" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/tree-orange" alt="" className="absolute bottom-3 left-[15%] w-16 sm:w-24" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/tree-green" alt="" className="absolute bottom-2 right-[3%] w-20 sm:w-32" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/tree-orange" alt="" className="absolute bottom-4 right-[17%] w-14 sm:w-20" />

      {/* Critters along the ground */}
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/butterfly" alt="" className="absolute bottom-8 right-[26%] w-10 sm:w-14 rotate-6" />
      <img src="https://res.cloudinary.com/xscf9i08/image/upload/snail" alt="" className="absolute bottom-4 left-[27%] w-14 sm:w-20" />
