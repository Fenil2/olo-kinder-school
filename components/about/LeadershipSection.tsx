          ...
          >
            <Motion variant={l.reverse ? 'right' : 'left'} className="shrink-0">
              <div className="relative w-56 sm:w-64 lg:w-72">
                <div className="relative aspect-square rounded-full overflow-hidden bg-card shadow-lg ring-8 ring-mascot-squarey">
                  <img
                    src={l.portrait}
                    alt={l.alt}
                    loading="lazy"
            ...
            <Motion variant={l.reverse ? 'left' : 'right'} delay={100} className="min-w-0 flex-1">
              <div className="text-center md:text-left">
                ...
                <div className="relative bg-card rounded-3xl border border-border shadow-sm p-6 sm:p-8 mt-6 text-left">
