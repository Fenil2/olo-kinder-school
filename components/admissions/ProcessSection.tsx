...
const steps: Step[] = [
  { step: 1, title: 'Submit Enquiry',        Icon: MdAssignment,  desc: "Fill in our simple enquiry form with your child's details. Our team will get in touch within 24 hours.", color: 'bg-surface-sky',    iconColor: 'text-mascot-squarey-dark' },
  { step: 2, title: 'School Interaction',    Icon: MdHandshake,   desc: 'Meet our educators online or in person to learn about our programme, philosophy, and what to expect.',   color: 'bg-mascot-starry/15',    iconColor: 'text-mascot-starry-dark'  },
  { step: 3, title: 'Campus Visit',          Icon: MdSchool,      desc: 'Bring your child for a guided visit so they can experience the Olo Kinder environment firsthand.',      color: 'bg-mascot-hexy/15',     iconColor: 'text-mascot-hexy-dark'    },
  { step: 4, title: 'Admission Confirmation',Icon: MdCelebration, desc: 'Complete the enrolment process and welcome your child to the Olo Kinder family!',                      color: 'bg-mascot-roundy/15',    iconColor: 'text-mascot-roundy-dark'  },
]
