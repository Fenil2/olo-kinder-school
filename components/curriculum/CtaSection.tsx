      ...
      <Motion variant="up">
        <div className="max-w-4xl mx-auto text-center text-foreground">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link href="/learning-experiences" className="border-2 border-foreground/60 text-foreground px-8 py-3 rounded-full hover:bg-foreground/10 transition-colors font-semibold">
