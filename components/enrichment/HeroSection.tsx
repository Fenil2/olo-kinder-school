 ...
 * the page's own three stills in it.
 *
 * Everything that makes that banner move is reused rather than rebuilt — the
 * same `BannerCarousel` — so the slow drift across each still, the crossfade
 * between them, the wash of brand-coloured light, the two mascots bobbing in
 * the upper corners, the frosted badge and the progress indicators all behave
 * exactly as they do on the home page, and a change to one changes both.
 *
